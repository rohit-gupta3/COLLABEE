            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Your Upcoming Activity</h1>
                      ...
                      <!-- Section: Timeline -->
                        <section class="py-5">
                            ...
                            <li class="timeline-item mb-5">
                                <h5 class="fw-bold"><?php echo $row['ptitle'];?> - <?php echo $row['deliverable'];?></h5>
                                <p class="text-muted mb-2 fw-bold"><?php echo $row['date'];?></p>
                                <p class="text-muted">
                                <?php echo $row['detail'];?>
                                </p>
                            </li>
                            ...
                            <!-- <li class="timeline-item mb-5">
                                <h5 class="fw-bold">Project 2 - SRS Submission</h5>
                            ...
                            <li class="timeline-item mb-5">
                                <h5 class="fw-bold">Project 3 - SDS Submission </h5>
                            ...
                            <li class="timeline-item mb-5">
                                <h5 class="fw-bold">Project 2 - GUI Design</h5>
