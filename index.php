            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-4">
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="viewdetails.php?id=<?php echo $row['ptitle'];?>" class="btn btn-success">view</a>
                        ...
                        ?>
                        <button type="button" class="create" onclick="window.open('project-add.php','name','width=800,height=600');" style="margin-top:70px;width:300px;height:180px;"><div style="font-size:60px;">+</div><br style="font-size:30px;">Create New Project</button>
                </div>
                    <!-- <div class="row mt-4">
                        <div class="col-md-3 mt-3">
                            <div class="card">
