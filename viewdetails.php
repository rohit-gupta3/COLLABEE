<?php
    ...
    $id= $_GET['id'];
    $sql = "SELECT * FROM projectdetails WHERE ptitle='$id';";
    $result = mysqli_query($conn,$sql);
    $row = mysqli_fetch_assoc($result);
    $expense = mysqli_fetch_assoc(mysqli_query($conn,"SELECT SUM(amount) as texpense FROM expensedetail WHERE ptitle='$id';"));
    
    // $remaining = number_format($row['budget']) - $expense['texpense'];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        Deadline Alert: You Have to deliver this product before Dec 2.
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="text-truncate">Hey, I have completed the integration module</div>
                                        <div class="small text-gray-500">Rishi</div>
                                    </div>
                                </a>
                ...
                <div class="container-fluid">
                    <!-- <input type="text" value="<?php echo $row['ptitle']?>"> -->
                    <table>
                        <tr>
                            <td>Project</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Project Head</td>
                            <td>:</td>
                            <td><?php echo $row['phead']?></td>
                        </tr>
                        <tr>
                            <td>Date of Completition</td>
                            <td>:</td>
                            <td><?php echo $row['doc']?></td>
                        </tr >
                        <tr>
                            <td style="color:red;">Total Spended </td>
                            <td style="color:red;">:</td>
                            <td style="color:red;"><?php echo $expense['texpense']?></td>
                        </tr>
                        <tr>
                            <td style="color:red;">Remaining </td>
                            <td style="color:red;">:</td>
                            <td style="color:red;"><?php echo $row['budget']-$expense['texpense']?></td>
                        </tr>
                    </table>
