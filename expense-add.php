<!-- this is the code for the expenses adding -->
<?php
    session_start();
    ...
    if(isset($_POST['submit']))
    {
        $person = $_POST['person'];
        $ptitle = $_POST['ptitle'];
        $spended = $_POST['spended'];
        $detail = $_POST['detail'];
        $invoice = $_POST['invoice'];
        $date = $_POST['date'];
        $amount = $_POST['amount'];
        $sql = "INSERT INTO `expensedetail`(`ptitle`, `person`, `spendedon`, `detail`, `date`, `invoice`, `amount`) VALUES ('$ptitle','$person','$spended','$detail','$date','$invoice','$amount')";
        try{
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Enter the Expenses Details</h1>
                    ...
                    <!-- <div>
                        <form id="form">
                            <div class="input-box">
                              <label class="input-label">Name of Expense:</label>
                              <input type="text" class="input-1" onfocus="setFocus(true)" onblur="setFocus(false)" />
                            </div>
                            <div class="input-box active-grey">
                                <label class="input-label">Type of Expense:</label>
                            ...
                            <div class="input-box active">
                              ...
                              <input type="date" class="input-1" onfocus="setFocus(true)" onblur="setFocus(false)" />
                            </div>
                             -->
                          ...
                          <div class="container px-5 my-5">
                            <form id="contactForm" method="post">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="nameOfPerson" type="text" name="person" placeholder="Name of Person" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="nameOfPerson:required">Name of Person is required.</div>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Project</label>
                                    <select class="form-control" name="ptitle" id="phead" aria-label="Title">
                                        <?php
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="spendOn">Spend on</label>
                                    <input class="form-control" id="spendOn" type="text" name="spended" placeholder="Spend on" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="spendOn:required">Spend on is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="detail">Detail</label>
                                    <textarea class="form-control" id="detail" type="text" name="detail" placeholder="Detail" data-sb-validations="required" /></textarea>
                                    <div class="invalid-feedback" data-sb-feedback="detail:required">Detail is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="date">Date</label>
                                    <input class="form-control" id="date" type="date" name="date" placeholder="Date" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="invoiceNumber" type="text" name="invoice" placeholder="Invoice Number" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="invoiceNumber:required">Invoice Number is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="amount">Amount</label>
                                    <input class="form-control" id="amount" type="number" name="amount" placeholder="Amount" data-sb-validations="required" />
